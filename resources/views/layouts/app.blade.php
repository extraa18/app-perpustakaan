...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .site-nav { background: #1e3a8a; padding: 14px 40px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; }
        .site-nav .brand { color: #fff; font-weight: bold; font-size: 18px; }
        .site-nav ul { list-style: none; display: flex; gap: 20px; margin: 0; padding: 0; }
        .site-nav ul li a { color: #cbd5e1; text-decoration: none; padding: 6px 4px; }
        .site-nav ul li a.active { color: #fff; font-weight: bold; border-bottom: 2px solid #fff; }        main { max-width: 900px; margin: 0 auto; padding: 30px 40px; }
        ...
        input, select, textarea { width: 100%; max-width: 400px; padding: 6px; margin-top: 4px; box-sizing: border-box; }
